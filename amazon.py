...
class Product(tk.Tk):
	def __init__(self):
		super().__init__()
		self.title("Amazon Listing Scraper")
		self.geometry("300x300")

		self.label = tk.Label(text="Enter a product name")
		self.label.pack()
	...
	def submit(self):
		...
		print("Product to scrape:", product)
		scrape_amazon(product, 1)

if __name__== '__main__':
	productFinder = Product()
	productFinder.mainloop()